...
class cfgWindow(MainClase):#MainClase):
    def __init__(self, *args):
        ...
        self.window = builder.get_object("cfgWindow")

        #Todos los spinbuttons necesarios
        self.spinbuttons = [
            #[label, cfgsect, cfgkey, rangef, ranget, incrementf, increment, parent],
            #["Anchura de la ventana", "GRAPHICS", "wres", 450, 1600, 5, 10],
            #["Altura de la ventana", "GRAPHICS", "hres", 450, 1600, 5, 10],
            ["Anchura", "GRAPHICS", "viewport-wres", 20, 100, 1, 5, builder.get_object("cfgwnd-frame-grid")],
            ["Altura", "GRAPHICS", "viewport-hres", 15, 100, 1, 5, builder.get_object("cfgwnd-frame-grid")],
            ["Lado de los cuadros", "GRAPHICS", "viewport-sqres", 32, 128, 5, 10, builder.get_object("cfgwnd-frame-grid")],
            #["Max logs", "DIRS", "Maxlogs", 3, 1000, 1, 5, builder.get_object("cfgwnd-frame-grid")],
        ]
        ...
        def set_spinner(lst):
            ...
            spinbutton.set_margin_left(5)

            #attach(child, left, top, width, height)
            tmplst[7].attach(label, 0, 1, 1, 1)
            tmplst[7].attach(spinbutton, 1, 1, 1, 1)
