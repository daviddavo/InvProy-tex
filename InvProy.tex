...
\usepackage[a4paper, left=3cm, right=3cm, top=3cm, bottom=2cm, headheight=14pt]{geometry}
...
{\color{DarkRed}\rule{0.5\textwidth}{2pt}\par}
\vspace{2cm}
...
\tableofcontents
\listoffigures Todas las imágenes son de autoría propia y siguen la licencia de este documento.
\newpage{}
...
En cuanto al código, a pesar de la gran extensión del programa, han sido escritas muchas más líneas, que han sido en algún momento eliminadas o reemplazadas. El desarrollo del proyecto puede dividirse en 4 fases, una por trimestre, aproximadamente.
