...
Todo el software que se ha usado para la creación de este programa es software libre. A continuación, se listan las herramientas que se han usado para la creación del programa.
...
\end{figure}
\begin{figure}[H]
\centering\includegraphics[width=0.9\textwidth]{Resources/Screenshots/2016-09-12-230644_1000x700_scrot.png}
...
\end{minted}
\end{multicols}
\centering\caption[Código: Algunas de las diferencias entre versiones]{Código: Algunas de las diferencias entre versiones. Podemos observar la reducción de líneas de código.}
\label{fig:diff}
\end{figure}
