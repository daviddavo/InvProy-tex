...
\centering
InvProy \hspace*{15pt} Copyright \hspace*{10pt} \copyright\hspace*{10pt} 2016 \hspace*{15pt} David Davó Laviña \\ \hspace*{15pt} david@ddavo.me \hspace*{10pt} \url{http://ddavo.me}

\vspace{0.7cm}
\noindent\centering
\begin{minipage}{13cm}
\centering Podrá encontrar una copia del documento, el programa, las licencias y las imágenes usadas en el CD adjunto.
\end{minipage}

\vspace*{0.5cm}
\centering\framebox[12.5cm]{\raisebox{0pt}[12.5cm][0pt]{}} \par
%\vspace*{\fill}
